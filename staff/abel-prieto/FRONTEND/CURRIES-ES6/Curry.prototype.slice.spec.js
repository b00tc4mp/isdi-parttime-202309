...
TEST('TEST Curries - Method Slice')

CASE('CASE for the curry, extract on a new curry from curry[1] to curry[5], last not included')
...
CASE('CASE for the curry, extract on a new curry from curry[4] to curry[9], last not included')
