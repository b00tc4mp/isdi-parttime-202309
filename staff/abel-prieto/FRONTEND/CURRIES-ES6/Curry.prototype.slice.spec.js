...
TEST('Curries - Method Slice')

CASE('For the curry, extract on a new curry from curry[1] to curry[5], last not included')
...
CASE('For the curry, extract on a new curry from curry[4] to curry[9], last not included')
