...
console.log('CASE construct curry with 3 arguments 10, 20, 30')
...
console.log(
  'CASE constructor fails curry with 1 argument that is a negative integer'
)
...
console.log(
  'CASE constructor fails curry with 1 argument that is a positive number, but not an integer'
)
