...
console.log('CASE for Filter Curry c to new array with values under 50 should return { 0: 10, 1: 20, 2: 30, 3: 40, length: 4}')
...
console.log('CASE for filter Curry c to new array with values over 50 should return Curry { 0: 60, length: 1}')
