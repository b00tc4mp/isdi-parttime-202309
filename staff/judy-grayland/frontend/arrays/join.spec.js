...
console.log(
  'CASE for join cardinalDirections array with no space should return the string "north, east, south, west"'
)
console.log(join(cardinalDirections, ''))
// 'northeastsouthwest'

console.log(
  'CASE for join cardinalDirections array with no separator should return the string "north, east, south, west"'
)
console.log(join(cardinalDirections))
// 'north,east,south,west'
console.log('------------------------------------------')
