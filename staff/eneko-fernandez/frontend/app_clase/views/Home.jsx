    ...
    return <div>
        <header className="home-header">
            ...
            <div>
                ...
                <button onClick={handleFavPosts}>Fav Posts</button>
        ...
        {view !== 'profile' && view !== 'fav-posts' && posts !== null && <div>
            {posts.map((post) => {
                ...
                return <article key={post.id} className="post">
                    ...
                    {post.author === logic.userId && <button>Delete</button>}
        ...
        {view === 'fav-posts' && favPosts.length > 0
            ?
            <div>
                {favPosts.map((post) => {
                    function handleToggleLikeButtonClick() {
