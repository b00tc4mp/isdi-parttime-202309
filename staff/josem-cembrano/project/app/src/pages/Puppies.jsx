        ...
        <div className="flex flex-wrap gap-1 flex-row pt-2">
        {
          puppies.lenght !== 0 && (puppies.map((puppy) => {
            ...
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                  <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{puppy.afix}</h5>
                        <h4 className="mb-2 text-1xl font-bold tracking-tight text-gray-900 dark:text-white">{puppy.name}</h4>
                        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{puppy.gender}</p>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{puppy.birthDate}</p>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{puppy.text}</p>
                </div>
            </div>
            </div>
          }))
