...
function Home(props) {
    ...
    return <div>
        ...
        {(view === null || view === 'new-post') && <Posts loadPosts={logic.retrievePosts.bind(logic)} stamp={stamp} />}{/*ESTE BIND, ES PARA UNIR (lOGIC) A LA FUNCION retrievePosts en el archivo Posts, porq al estar en diferentes archivos pierde el contexto*/}
