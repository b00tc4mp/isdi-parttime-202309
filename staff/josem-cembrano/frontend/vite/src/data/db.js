...
// USERS
db.users.insert(new User(null, "Wendy Darling", "wendy@darling.com", "123", []), () => {
    db.users.insert(new User(null, "Peter Pan", "peter@pan.com", "123", []), () => {
        db.users.insert(new User(null, "chema", "chema@chema.com", "123", []), () => {
