class Collection {
    ...
    deleteById(id, callback) {
        try {
            ...
            asyncDelay(() => {
                const index = this.__findIndexById__(id) // Encuentra el índice del documento por su ID
                ...
                this.__documents__.splice(index, 1) // Elimina el documento del array de documentos

                callback(null) // Llama al callback indicando una eliminación exitosa
            }, 0.3)
