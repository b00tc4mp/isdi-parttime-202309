...
*/
    ...
    return <div>
        <header className="home-header">
            ...
            <div>
                <button className="button" id="new-post-button" onClick={handleNewPostClick}>+</button>
                &nbsp;

                <a className="link" href="" onClick={handleProfileClick}>{name}</a>
                &nbsp;
                <a className="link" href="#" onClick={handleFavPostsClick}>Favs</a>
                &nbsp;
            ...
            {posts.map((post) => {
                ...
                return <article key={post.id} className="post">
                    ...
                    <div className='buttons-posts'>
                        <button className="button button-submit" onClick={() => handleToggleLikePostClick(post.id)}>{post.liked ? '❤️' : '🤍'} {post.likes.length} likes</button>
                        <button className="button button-submit" onClick={() => handleToggleFavPostClick(post.id)}>{post.fav ? '⭐️' : 'Fav'}</button>
                        {post.author.id === logic.sessionUserId && <button className="button button-submit" onClick={() => handleDeletePostClick(post.id)}>Delete post</button>}
                    </div>
                </article>
            })}
        </div>
