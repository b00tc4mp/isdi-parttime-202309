class Logic {
    ...
    retrieveUser() {
        const user = db.users.findPostById (this.sessionUserId)
    ...
    retrievePosts() {
        ...
        posts.forEach (post => {
            post.like = post.likes.includes (this.sessionUserId)
    ...
    retrieveFavPosts () {
        ...
        const favs = user.favs.map (postId => db.postsfindById(postId))
