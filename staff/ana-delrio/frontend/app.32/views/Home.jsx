function Home(props) {
    ...
    const view = viewState[0] // valor actual de la vista
    const setView = viewState[1] // función par actualizar la vista 

    // estado para manejar el tiempo de la última acción
    const timestampState = React.useState(null)
    const setTimestamp = timestampState[1] // función para actualizar el timestamp
