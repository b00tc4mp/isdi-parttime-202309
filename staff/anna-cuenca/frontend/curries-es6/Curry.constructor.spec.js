...
CASE(
  "construct curry with 1 argument that is not a positive integer, but a boolean"
);
...
CASE(
  "construct curry with 1 argument that is not a positive integer, but a string"
);
...
CASE(
  "constructor fails with 1 argument that is a positive number, not integer"
);
