...
function Post(props) {
    ...
    return (<article className="post">
        ...
        <div className="post-actions">
            ...
            {post.author.id === context.sessionUserId && (<Button onClick={() => handleToggleDeletePostClick(post.id)}>🗑</Button>)}
            {post.author.id === context.sessionUserId && editTextPost === null && <Button onClick={handleEditClick}> 🖍</Button>}
