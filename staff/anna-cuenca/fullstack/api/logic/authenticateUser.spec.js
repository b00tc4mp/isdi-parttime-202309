...
describe('authenticateUser', () => {
    ...
    it('succeeds on correct credentials', done => {
        authenticateUser('remo@lacha.com', '123123123', (error, userId) => {
            if (error) {
                done(error)
                return
            }
            ...
            expect(userId).to.equal('659a904a06ac064c6025bc91')
    ...
    it('fails on wrong email', done => {
        authenticateUser('remo@lacha2.com', '123123123', (error, userId) => {
            try {
