...
class OttoController {
    ...
    async shakeLeg(userId, steps, T, dir) {
        if (!this.otto) {
            throw new Error("Otto is not initialized")
        }
        await movement.shakeLeg(this.otto, userId, steps, T, dir) // Uso del movimiento upDown
    }
