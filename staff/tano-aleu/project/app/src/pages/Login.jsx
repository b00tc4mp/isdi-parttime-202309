...
function Login(props) {
    ...
    return <div className="bg-[#5F5784] border rounded-3xl p-4 border-blackflex flex-col overflow-auto min-h-screen mx-auto max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
