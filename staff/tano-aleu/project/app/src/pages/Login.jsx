...
function Login(props) {
    ...
    return <div className="bg-[#5F5784] border rounded-3xl p-10 border-blackflex flex-col space-y-1 overflow-auto min-h-screen mx-auto max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
