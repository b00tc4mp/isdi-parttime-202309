// Importa el objeto de la base de datos y las clases de modelos
import db from './db';
import { User, Post, CreditCard } from './models';

// Registra la hora antes de realizar operaciones en la base de datos
const before = Date.now();

// Inserta dos usuarios en la base de datos
db.users.insert(new User(null, 'Wendy Darling', 'wendy@darling.com', '123123123', []), () => {
    db.users.insert(new User(null, 'Peter Pan', 'peter@pan.com', '123123123', []), () => {
        ...
        // Inserta algunas publicaciones para cada usuario
