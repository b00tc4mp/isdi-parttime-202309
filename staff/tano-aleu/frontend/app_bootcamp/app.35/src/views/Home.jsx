...
function Home(props) {
    ...
    return <div>
        ...
        {(view === null || view === 'new-post') && posts !== null && <div>
            {posts.map(post => <Post post={post} onToggleLikeClick={handleToggleLikePostClick} onToggleFavClick={handleToggleFavPostClick}/>)}
        </div>}

        {view === 'favs' && favs !== null && <div>
            {favs.map(post => <Post post={post} onToggleLikeClick={handleToggleLikePostClick} onToggleFavClick={handleToggleFavPostClick}/>)}
        </div>}
    </div>
}
