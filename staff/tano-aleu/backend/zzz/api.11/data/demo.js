...
client.connect()
    .then(connector => {
        ...
        // users.findOne({ _id: new ObjectId('6581f9b3bc4abd5315fc8c28') })
        ...
        // posts.insertOne({ author: new ObjectId('65a53f98acdac7175a73b080'), image: 'http://image.com/peter', text: 'hello, peter!', likes: [] })
        //     .then(result => console.log('inserted', result))
        //     .catch(error => console.error(error))

        posts.find({ author: new ObjectId('65a53f98acdac7175a73b080') }).toArray()
